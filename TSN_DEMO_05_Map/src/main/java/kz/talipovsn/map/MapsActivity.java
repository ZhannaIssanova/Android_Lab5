...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.26764039042824, 76.96721472956234); // Начальный маркер
    static final LatLng marker1 = new LatLng(52.27682876627417, 76.97056384731819); // Маркер Каспи Банка
    static final LatLng marker2 = new LatLng(52.27673347748959, 76.96961050178197); // Маркер Халык Банка
    static final LatLng marker3 = new LatLng(52.268497146918186, 76.95021897397275); // Маркер Банка Хоум Кредит
    static final LatLng marker4 = new LatLng(52.27640034362175, 76.96950512042599); // Маркер Евразийского Банка
    static final LatLng marker5 = new LatLng(52.281164565529515, 76.96201751160169); // Маркер Альфа Банка
